...
export default function Home() {
  ...
  const [chunks, setChunks] = useState<MBChunk[]>([]);
  ...
  const handleSearch = async () => {
    ...
    const results: MBChunk[] = await searchResponse.json();
  ...
  return (
    <>
      <Head>
        <title>The Mahabharata GPT</title>
        <meta
          name="description"
          content={`AI-powered search and chat for the Mahabharata retold by C. Rajagopalachari.`}
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        {/* add other icons also */}
          ...
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {showSettings && (
              <div className="w-[340px] sm:w-[400px]">
                ...
                {/* <div className="mt-2">
                  <div>OpenAI API Key(Kindly use your API Key)</div>
                  <input
                    type="password"
            ...
            <div className="relative w-full mt-4">
              ...
              <input
                ...
                type="text"
                placeholder="How was the epic Mahabharata written?"
                value={query}
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search and chat for the Mahabharata retold by C. Rajagopalachari.`}</div>
            )}
          </div>
        </div>
        <Footer />
